...
BasisFunctionSettings inverse_log_power_settings = {false, 2, 3, inverse_log_power};
BasisFunctionSettings scaled_inverse_log_power_settings = {true, 2, 3, inverse_log_power};
BasisFunctionSettings inverse_power_settings = {false, 0.5, 1.5, inverse_power};
BasisFunctionSettings scaled_inverse_power_settings = {true, 0.5, 1.5, inverse_power};
